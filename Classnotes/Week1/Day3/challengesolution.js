...
/* BRONZE
 * Write two variables. One will store your name and another will store a friend's name. Find out what property you can use to check how long the names are. 
...
*/
let myName = 'Danielle';
let friendsName = 'Justin';

console.log(myName.length)
console.log(friendsName.length)

if (myName.length > friendsName.length) {
    let letters = myName.length - friendsName.length
    console.log(`${friendsName}'s name is shorter than ${myName}'s name by ${letters} letters.`)
} else if (myName.length < friendsName.length) {
    let letters = friendsName.length - myName.length
    console.log(`${friendsName}'s name is longer than ${myName}'s name by ${letters} letters.`)
} else {
